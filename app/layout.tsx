...
export const metadata: Metadata = {
  title: "Iceberg — DeFi Risk Analysis",
  description: "The risk beneath your yield. Analyze DeFi transactions for smart contract risk, governance exposure, and yield mechanics.",
};
