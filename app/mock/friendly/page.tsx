...
// FRIENDLY. penguin in header + verdict next to score.
// Plain-English risk pills. Best balance of personality + credibility.
...
export default function FriendlyMock() {
  return (
    ...
    <div className="flex items-center justify-between pb-4">
      <Link href="/mock" className="flex items-center gap-3">
        <div className="relative">
          <Image src="/cat-dad.png" alt="" width={48} height={48} className="rounded-xl" />
          <span
  ...
  return (
    <Card>
      <div className="flex items-center justify-between">
        ...
        <div className={`text-[11px] ${MUTED}`}>Click any row for details</div>
      </div>
